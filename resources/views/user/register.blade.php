                ...
                <form action="/register" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="role" required
                            class="w-full px-4 py-3 border-2 border-black rounded focus:outline-none">
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="text-sm">Tôi đồng ý với <a href="#"
                                class="font-bold hover:underline">Điều khoản sử dụng</a></label>
                    </div>
