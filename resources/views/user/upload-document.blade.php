        ...
        <form action="/api/documents/upload" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" required rows="5"
                    placeholder="Mô tả chi tiết về tài liệu của bạn..."
                    class="w-full px-4 py-3 border-2 border-black rounded focus:outline-none focus:bg-black focus:text-white transition"></textarea>
            </div>

            <!-- Category -->
            <div>
                <label class="block font-semibold mb-2">Chủ Đề *</label>
                <select name="category" required class="w-full px-4 py-3 border-2 border-black rounded focus:outline-none">
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-black rounded p-8 text-center cursor-pointer hover:bg-gray-50 transition">
                    ...
                    <div onclick="document.getElementById('file-input').click()">
                        ...
                        <p class="text-xs text-gray-500 mt-3">Định dạng hỗ trợ: PDF, DOC, DOCX, TXT, PPTX (Max 100MB)</p>
                    </div>
                </div>
            ...
            <div class="border-2 border-black rounded p-4 bg-gray-50">
                <label class="flex items-start">
                    ...
                    <span class="text-sm">
                        ...
                        Tôi đồng ý với <a href="#" class="font-bold hover:underline">Điều khoản sử dụng</a> của TaiLieuHub.
                    </span>
                </label>
            </div>
